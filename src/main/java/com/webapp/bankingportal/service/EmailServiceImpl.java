...
public class EmailServiceImpl implements EmailService {
    ...
    public String getLoginEmailTemplate(String name, String loginTime, String loginLocation) {
        return "<div style=\"font-family: Helvetica, Arial, sans-serif; min-width: 320px; max-width: 1000px; margin: 0 auto; overflow: auto; line-height: 2; background-color: #f1f1f1; padding: 20px;\">"
                ...
                + "</a>" + "<h1 style=\"font-size: 1.8em; color: #3f51b5; margin: 10px 0;\">WeavusBank</h1>" + "</div>"
                + "<div style=\"padding: 20px;\">" + "<p style=\"font-size: 1.2em; color: #333;\">안녕하세요, " + name + ",</p>"
                + "<p style=\"font-size: 1em; color: #333;\">귀하의 계정에서 ログイン 시도가 있었습니다:</p>"
                ...
                + "<p style=\"font-size: 1em; color: #333;\">ログイン 시도가 있었습니다. 본인이라면 추가 조치가 필요하지 않습니다. 무단 액세스가 의심되는 경우 즉시 비밀번호를 변경하고 지원팀에 문의해 주세요.</p>"
                + "<p style=\"font-size: 1em; color: #555;\">감사합니다.<br />The WeavusBank Team</p>" + "</div>"
                + "<hr style=\"border: none; border-top: 1px solid #ddd; margin: 20px 0;\" />"
                + "<div style=\"text-align: center; font-size: 0.9em; color: #888;\">"
                + "<p>Need help? Contact our support team:</p>"
                + "<p>Email: <a href=\"mailto:weavusbank@google.com\" style=\"color: #3f51b5; text-decoration: none;\">weavusbank@google.com</a></p>"
