...
public class ValidationUtil {
	...
	/*
	 * public static boolean isValidCountryCode(String countryCode) { if
	 * (!phoneNumberUtil.getSupportedRegions().contains(countryCode)) { return
	 * false; }
	 * 
	 * return true; }
	 */
    ...
    public static void validateUserDetailsNotEmpty(User user) {
		...
		/*
		 * if (user.getCountryCode() == null || user.getCountryCode().isEmpty()) { throw
		 * new
		 * UserInvalidException(ApiMessages.USER_COUNTRY_CODE_EMPTY_ERROR.getMessage());
		 * }
		 */
    ...
    public static void validateUserDetails(User user) {
		...
		/*
		 * if (!isValidCountryCode(user.getCountryCode())) { throw new
		 * UserInvalidException(String.format(ApiMessages.
		 * USER_COUNTRY_CODE_INVALID_ERROR.getMessage(), user.getCountryCode())); }
		 * 
		 * if (!isValidPhoneNumber(user.getPhoneNumber(), user.getCountryCode())) {
		 * throw new UserInvalidException(String.format(ApiMessages.
		 * USER_PHONE_NUMBER_INVALID_ERROR.getMessage(), user.getPhoneNumber(),
		 * user.getCountryCode())); }
		 */
