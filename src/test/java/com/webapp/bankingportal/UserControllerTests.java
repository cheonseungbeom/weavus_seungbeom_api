...
public class UserControllerTests extends BaseTest {
	...
	/*
	 * @Test public void test_register_user_with_empty_country_code() throws
	 * Exception { val user = createUser(); //user.setCountryCode("");
	 * 
	...
	/*
	 * @Test public void test_register_user_with_missing_country_code() throws
	 * Exception { val user = createUser(); //user.setCountryCode(null);
	 * 
	 * mockMvc.perform(MockMvcRequestBuilders .post("/api/users/register")
	 * .contentType(MediaType.APPLICATION_JSON) .content(JsonUtil.toJson(user)))
	 * .andExpect(MockMvcResultMatchers.status().isBadRequest())
	...
	/*
	 * @Test public void test_register_user_with_invalid_country_code() throws
	 * Exception { val user = createUser(); val countryCode = faker.lorem().word();
	 ...
	 * .andExpect(MockMvcResultMatchers.status().isBadRequest())
	 * .andExpect(MockMvcResultMatchers.content()
	 * .string(String.format(ApiMessages.USER_COUNTRY_CODE_INVALID_ERROR.getMessage(
	 * ), countryCode))); }
	 */
